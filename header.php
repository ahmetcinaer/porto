<?php include 'admin/setting/baglan.php';
						...
						<div class="header-row">
							<div class="header-column">
								<div class="header-logo">
									<a href="index.php">
										<img alt="Porto" width="164" height="54" data-sticky-width="82" data-sticky-height="40" data-sticky-top="33" src="<?php echo $ayarcek['ayar_logo']; ?>">
									</a>
								</div>
							</div>
							<div class="header-column">
								<ul class="header-extra-info">
									...
									<li class="hidden-xs">
										<div class="feature-box feature-box-mail feature-box-style-2">
											...
											<div class="feature-box-info">
												<h4 class="mb-none"><a href="<?php echo $ayarcek['ayar_mail']; ?>"><?php echo $ayarcek['ayar_mail']; ?></a></h4>
											</div>
										</div>
									</li>
								</ul>
