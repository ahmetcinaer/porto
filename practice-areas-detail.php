...
<div role="main" class="main">
    <div class="container">
        <div class="row pt-xl">
            ...
            <div class="col-sm-9">
                ...
                <div class="row mt-xl mb-xl">
                    <div class="col-sm-4 center">
                        <img src="img/office/our-office-8.jpg" class="img-responsive mb-xl" alt="">
                    </div>
                    <div class="col-sm-8">
                        <h1 class="mt-none mb-sm">Criminal Law</h1>
                ...
                <div class="row mt-xl">
                    <div class="col-sm-12">
                        ...
                        <h2 class="mt-xlg mb-md">Related Links</h2>
            ...
            <div class="col-sm-3">
                <aside class="sidebar">
                    <h4 class="mt-xl mb-none">Related Attorneys</h4>
                    <div class="divider divider-primary divider-small mb-xl">
                        <hr>
                    </div>
                    ...
                    <div class="owl-carousel owl-theme" data-plugin-options='{"items": 1, "animateOut": "fadeOut", "autoplay": true, "autoplayTimeout": 3000}'>
                        <div class="center">
                            ...
                            <h5 class="p-none m-none pt-md">David Doe</h5>
                        </div>
                        <div class="center">
                            <a href="demo-law-firm-attorneys-detail.html">
                                <span class="thumb-info thumb-info-centered-info thumb-info-no-borders">
                            ...
                            <h5 class="p-none m-none pt-md">Jeff Doe</h5>
                        </div>
                    </div>
