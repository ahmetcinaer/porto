                  ...
                  <form action="../setting/islem.php" method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="file" id="Slider_url" name="Slider_url" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="slider_link" name="slider_link" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="slider_sira" name="slider_sira" required="required" value="0" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
